            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-round">
                        <div class="card-header">Data Ukm
                            <a href="{{ route('ukm.create') }}" class="btn btn-outline-primary" style="float: right">Tambah</a>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                ...
                                <tbody>
                                    ...
                                    @foreach ($ukm as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('/storage/ukm/' . $data->foto) }}" width="100"
                                                    alt="">
                                            </td>
                                            <th>
